        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <a href="#stats" className="text-gray-300 hover:text-white transition-colors text-sm">
                {t('stats') || 'Statistics'}
              </a>
              <a href="#compare" className="text-gray-300 hover:text-white transition-colors text-sm">
                {t('compare') || 'Compare'}
              </a>
            </div>
